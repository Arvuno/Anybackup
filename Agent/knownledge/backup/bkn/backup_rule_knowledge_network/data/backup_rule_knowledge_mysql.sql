...
CREATE TABLE `backup_plan` (
  ...
  `min_data_size_gb` INT DEFAULT NULL,
  `max_data_size_gb` INT DEFAULT NULL,
...
INSERT INTO `backup_plan` VALUES ('PS_01_FULL','PS_01','MySQL普通数据-逻辑增量策略-完全备份','mysql','周级计划',1,'01:00',NULL,'周日',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'完全备份',0,NULL,NULL,1,'适用于MySQL普通数据场景的默认推荐策略。'),('PS_01_INCR','PS_01','MySQL普通数据-逻辑增量策略-增量备份','mysql','天级计划',1,'01:00',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'增量备份',0,NULL,NULL,2,'适用于MySQL普通数据场景的默认推荐策略。'),('PS_02_FULL','PS_02','MySQL实时交易-物理实时日志策略-完全备份','mysql','周级计划',1,'00:30',NULL,'周日',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'完全备份',1,NULL,NULL,1,'适用于要求分钟级RPO的MySQL实时交易业务。'),('PS_02_INCR','PS_02','MySQL实时交易-物理实时日志策略-增量备份','mysql','天级计划',1,'00:30',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'增量备份',1,NULL,NULL,2,'适用于要求分钟级RPO的MySQL实时交易业务。'),('PS_02_LOG','PS_02','MySQL实时交易-物理实时日志策略-日志备份','mysql','分钟级计划',1,'00:00',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'日志备份',1,NULL,NULL,3,'适用于要求分钟级RPO的MySQL实时交易业务。'),('PS_03_FULL','PS_03','MySQL重要数据-逻辑增量策略-完全备份','mysql','周级计划',1,'01:30',NULL,'周日',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'完全备份',0,NULL,NULL,1,'适用于重要级MySQL数据的标准增量备份策略。'),('PS_03_INCR','PS_03','MySQL重要数据-逻辑增量策略-增量备份','mysql','天级计划',1,'01:30',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'增量备份',0,NULL,NULL,2,'适用于重要级MySQL数据的标准增量备份策略。'),('PS_04_FULL','PS_04','MySQL敏感数据-每日全备策略-完全备份','mysql','天级计划',1,'02:00',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'完全备份',0,NULL,NULL,1,'适用于敏感MySQL数据的每日全量备份策略。'),('PS_05_FULL','PS_05','Oracle实时交易-物理实时日志策略-完全备份','oracle','周级计划',1,'00:30',NULL,'周日',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'完全备份',1,NULL,NULL,1,'适用于Oracle实时交易业务的低RPO策略。'),('PS_05_INCR','PS_05','Oracle实时交易-物理实时日志策略-增量备份','oracle','天级计划',1,'00:30',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'增量备份',1,NULL,NULL,2,'适用于Oracle实时交易业务的低RPO策略。'),('PS_05_LOG','PS_05','Oracle实时交易-物理实时日志策略-日志备份','oracle','分钟级计划',1,'00:00',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'日志备份',1,NULL,NULL,3,'适用于Oracle实时交易业务的低RPO策略。'),('PS_06_FULL','PS_06','Oracle财务核心-物理增强策略-完全备份','oracle','周级计划',1,'01:00',NULL,'周日',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'完全备份',1,NULL,NULL,1,'适用于Oracle财务和核心数据库的标准增强策略。'),('PS_06_INCR','PS_06','Oracle财务核心-物理增强策略-增量备份','oracle','天级计划',1,'01:00',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'增量备份',1,NULL,NULL,2,'适用于Oracle财务和核心数据库的标准增强策略。'),('PS_06_LOG','PS_06','Oracle财务核心-物理增强策略-日志备份','oracle','分钟级计划',1,'00:00',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'日志备份',1,NULL,NULL,3,'适用于Oracle财务和核心数据库的标准增强策略。'),('PS_07_FULL','PS_07','文件普通数据-标准文件备份策略-完全备份','file','周级计划',1,'02:00',NULL,'周日',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'完全备份',0,NULL,NULL,1,'适用于文件普通数据的标准文件备份策略。'),('PS_07_INCR','PS_07','文件普通数据-标准文件备份策略-增量备份','file','天级计划',1,'02:00',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'增量备份',0,NULL,NULL,2'适用于文件普通数据的标准文件备份策略。'),('PS_08_FULL','PS_08','文件敏感数据-加密文件备份策略-完全备份','file','周级计划',1,'03:00',NULL,'周日',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'完全备份',0,NULL,NULL,1,'适用于敏感文件数据的加密备份策略。'),('PS_08_INCR','PS_08','文件敏感数据-加密文件备份策略-增量备份','file','天级计划',1,'03:00',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'增量备份',0,NULL,NULL,2,'适用于敏感文件数据的加密备份策略。'),('PS_09_FULL','PS_09','Oracle普通数据-物理标准策略-完全备份','oracle','周级计划',1,'02:00',NULL,'周日',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'完全备份',0,NULL,NULL,1,'适用于Oracle普通业务的标准物理备份策略。'),('PS_09_INCR','PS_09','Oracle普通数据-物理标准策略-增量备份','oracle','天级计划',1,'02:00',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'增量备份',0,NULL,NULL,2,'适用于Oracle普通业务的标准物理备份策略。'),('PS_10_FULL','PS_10','MySQL普通数据-每日全备稳妥策略-完全备份','mysql','天级计划',1,'01:00',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'完全备份',0,NULL,NULL,1,'适用于普通MySQL业务的恢复优先型候选策略。'),('PS_11_FULL','PS_11','MySQL普通数据-高频增量增强策略-完全备份','mysql','周级计划',1,'00:30',NULL,'周日',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'完全备份',0,NULL,NULL,1,'适用于需要更快恢复和更低RPO的MySQL普通业务候选策略。'),('PS_11_INCR','PS_11','MySQL普通数据-高频增量增强策略-增量备份','mysql','天级计划',1,'00:30',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'增量备份',0,NULL,NULL,2,'适用于需要更快恢复和更低RPO的MySQL普通业务候选策略。'),('PS_12_FULL','PS_12','Oracle普通数据-高频增量增强策略-完全备份','oracle','周级计划',1,'00:30',NULL,'周日',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'完全备份',0,NULL,NULL,1,'适用于Oracle普通业务的增强恢复候选策略。'),('PS_12_INCR','PS_12','Oracle普通数据-高频增量增强策略-增量备份','oracle','天级计划',1,'00:30',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'增量备份',0,NULL,NULL,2,'适用于Oracle普通业务的增强恢复候选策略。'),('PS_13_FULL','PS_13','文件普通数据-政务归档增强策略-完全备份','file','周级计划',1,'01:00',NULL,'周日',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'完全备份',0,NULL,NULL,1,'适用于政务归档类文件数据的长期留存候选策略。'),('PS_13_INCR','PS_13','文件普通数据-政务归档增强策略-增量备份','file','天级计划',1,'01:00',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'增量备份',0,NULL,NULL,2,'适用于政务归档类文件数据的长期留存候选策略。'),('PS_14_FULL','PS_14','MySQL系统日志-能源高频增量策略-完全备份','mysql','周级计划',1,'00:30',NULL,'周日',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'完全备份',0,NULL,NULL,1,'适用于能源行业系统日志和生产明细的高频候选策略。'),('PS_14_INCR','PS_14','MySQL系统日志-能源高频增量策略-增量备份','mysql','天级计划',1,'00:30',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'增量备份',0,NULL,NULL,2,'适用于能源行业系统日志和生产明细的高频候选策略。');
...
CREATE TABLE `backup_solution` (
  ...
  `target_rpo_minutes` INT DEFAULT NULL,
  `target_rto_minutes` INT DEFAULT NULL,
...
CREATE TABLE `backup_window` (
  ...
  `max_speed_mib` INT DEFAULT NULL,
  `priority` INT DEFAULT NULL,
  `description` text DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `legal_rule` (
  ...
  `data_type` varchar(32) DEFAULT NULL,
  `data_level` varchar(32) DEFAULT NULL,
  `max_rpo_minutes` INT DEFAULT NULL,
  `max_rto_minutes` INT DEFAULT NULL,
  `min_retention_days` INT DEFAULT NULL,
...
CREATE TABLE `recommendation_policy` (
  ...
  `default_rpo_minutes` INT DEFAULT NULL,
  `default_rto_minutes` INT DEFAULT NULL,
  `default_backup_window` varchar(32) DEFAULT NULL,
  `max_candidate_count` INT DEFAULT NULL,
  `matched_legal_rule_ids` varchar(32) DEFAULT NULL,
  `compliance_weight` INT DEFAULT NULL,
  `data_type_weight` INT DEFAULT NULL,
  `rpo_weight` INT DEFAULT NULL,
  `rto_weight` INT DEFAULT NULL,
  `window_weight` INT DEFAULT NULL,
...
CREATE TABLE `retention_plan` (
  ...
  `data_retention_duration_value` INT DEFAULT NULL,
  `data_retention_duration_unit` varchar(32) DEFAULT NULL,
  `data_retention_count` INT DEFAULT NULL,
  `periodic_retention_enabled` SMALLINT DEFAULT NULL,
  `daily_copy_count` INT DEFAULT NULL,
  `weekly_copy_count` INT DEFAULT NULL,
  `monthly_copy_count` INT DEFAULT NULL,
  `quarterly_copy_count` INT DEFAULT NULL,
  `yearly_copy_count` INT DEFAULT NULL,
  `log_retention_enabled` SMALLINT DEFAULT NULL,
  `log_retention_duration_value` INT DEFAULT NULL,

...
func newObjectInfoCommand() meta.CommandMeta {
	return meta.CommandMeta{
		Domain:        "vmware",
		CanonicalPath: []string{"vmware", "object", "info"},
		Use:           "info",
		Description:   "Get VMware object info",
		...
		BuildRequest: func(rt *meta.Runtime) (console.RequestSpec, error) {
			return console.RequestSpec{
				...
				Path:     fmt.Sprintf("/backupmgm/v1/virtual/vmware/%s/info", rt.String("object-id")),
				ReadOnly: true,
			}, nil
		},
	}

...
func newObjectListCommand() meta.CommandMeta {
	return meta.CommandMeta{
		Domain:        "vmware",
		CanonicalPath: []string{"vmware", "object", "list"},
		Use:           "list",
		Description:   "List VMware VMs",
		...
		BuildRequest: func(rt *meta.Runtime) (console.RequestSpec, error) {
			return console.RequestSpec{
				...
				Path:     fmt.Sprintf("/backupmgm/v1/virtual/vmware/%s/get_vms", rt.String("production-system-id")),
				ReadOnly: true,
			}, nil
		},
	}

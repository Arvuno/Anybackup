...
func newRecoveryDetailCommand() meta.CommandMeta {
	return meta.CommandMeta{
		Domain:        "vmware",
		CanonicalPath: []string{"vmware", "recovery-detail"},
		Use:           "recovery-detail",
		Description:   "Get VMware recovery task detail",
		...
		BuildRequest: func(rt *meta.Runtime) (console.RequestSpec, error) {
			return console.RequestSpec{
				...
				Path:     fmt.Sprintf("/backupmgm/v1/virtual/vmware/recovery_task/%s/detail", rt.String("task-id")),
				ReadOnly: true,
			}, nil
		},
	}

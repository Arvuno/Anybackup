...
func newClientListCommand() meta.CommandMeta {
	return meta.CommandMeta{
		Domain:        "protect",
		CanonicalPath: []string{"protect", "client", "list"},
		Use:           "list",
		Description:   "List related clients by object ID",
		...
		BuildRequest: func(rt *meta.Runtime) (console.RequestSpec, error) {
			return console.RequestSpec{
				...
				Path:     fmt.Sprintf("/backupmgm/v2/protect_object/%s/clients", rt.String("object-id")),
				ReadOnly: true,
			}, nil
		},
	}

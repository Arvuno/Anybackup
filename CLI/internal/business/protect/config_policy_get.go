...
func newConfigPolicyGetCommand() meta.CommandMeta {
	return meta.CommandMeta{
		Domain:        "protect",
		CanonicalPath: []string{"protect", "config-policy", "get"},
		Use:           "get",
		Description:   "Get protect config policy by object ID",
		...
		BuildRequest: func(rt *meta.Runtime) (console.RequestSpec, error) {
			return console.RequestSpec{
				...
				Path:     fmt.Sprintf("/backupmgm/v2/%s/config_police", rt.String("object-id")),
				ReadOnly: true,
			}, nil
		},
	}
